"""
DD Content Browser - Standalone Launcher (HOME version)
Launch the content browser without Maya - for home use

Usage:
    python standalone_launcher_home.py
"""
...
# HOME VERSION: No company libraries, will use pip-installed packages
# Company lib path (for reference, but won't be used at home):
...
def main():
    """Launch standalone content browser (HOME version)"""
    print("=" * 60)
    print("DD Content Browser - Standalone (HOME)")
    print("=" * 60)
    ...
    try:
        ...
        # Apply Maya-like dark stylesheet
        app.setStyleSheet("""
            QMainWindow {
    ...
    try:
        ...
        # Look for icon in parent icons folder
    ...
    browser.setWindowTitle("DD Content Browser (Standalone - HOME)")
