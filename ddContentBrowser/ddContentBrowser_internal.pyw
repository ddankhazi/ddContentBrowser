"""
DD Content Browser - Standalone Launcher (INTERNAL - NO CONSOLE)
Launch the content browser without Maya - no console window
Uses internal company Python 3.11 installation

Usage:
    Double-click this file (use launch_standalone_silent.bat)
    OR: C:\Python311\pythonw.exe ddContentBrowser_internal.pyw
"""
...
try:
    ...
    try:
        ...
        messagebox.showerror(
            "DD Content Browser - Error",
            "PySide2 or PySide6 required!\n\n"
            "Check company libraries at:\n"
            "C:\\dApps\\extensions\\python\\python_libraries\\3.11\\win64"
        )
        sys.exit(1)
...
try:
    ...
    messagebox.showerror(
        "DD Content Browser - Error",
        f"Error importing browser module:\n\n{e}\n\n"
...
def main():
    """Launch standalone content browser (INTERNAL - NO CONSOLE)"""
    try:
        ...
        if app is None:
            ...
            try:
                import ctypes
                myappid = 'ddankhazi.DDContentBrowser.Internal.1.0'
        ...
        # Show error dialog for any unhandled exception
        import tkinter as tk
        from tkinter import messagebox
